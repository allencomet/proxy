...
//将缓冲区数据写入到文件
        ...
        void LevelLogger::install_signal_handler() {
            ...
            //sys::signal.add_handler(SIGTERM, std::bind(&LevelLogger::on_signal, this, SIGTERM), SA_RESTART | SA_ONSTACK);
            //sys::signal.add_handler(SIGQUIT, std::bind(&LevelLogger::on_signal, this, SIGQUIT), SA_RESTART | SA_ONSTACK);
            //sys::signal.add_handler(SIGINT, std::bind(&LevelLogger::on_signal, this, SIGINT), SA_RESTART | SA_ONSTACK);
